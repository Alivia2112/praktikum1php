        ...
        <div class="col-md-6 mt-3">
            <div class="card">
                ...
                <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="matkul" id="matkul" class="form-control">
                                            <option value="DDP">Dasar-Dasar Pemrograman (DDP)</option>
                                            <option value="BDI">Basis Data I (BDI)</option>
                                            <option value="WEB1">Pemrograman Web (WEB1)</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                    ...
                    $ns1 = ['id' => 1, 'nama' => 'Tsana', 'nim' => '01101', 'matkul' => 'DDP', 'uts' => 80, 'uas' => 84, 'tugas' => 78];
                    $ns2 = ['id' => 2, 'nama' => 'Adipati Dolken', 'nim' => '01121', 'matkul' => 'WEB1', 'uts' => 70, 'uas' => 50, 'tugas' => 68];
                    $ns3 = ['id' => 3, 'nama' => 'Pamungkas', 'nim' => '01130', 'matkul' => 'BDI', 'uts' => 60, 'uas' => 86, 'tugas' => 70];
                    $ns4 = ['id' => 4, 'nama' => 'Yusuf Filasafa', 'nim' => '01134', 'matkul' => 'DDP', 'uts' => 90, 'uas' => 91, 'tugas' => 82];
                ...
                <div class="card-footer">
                    <h6 class="text-center">Created By Alivia Aulia Ramadhanty &copy;2021</h6>
                </div>
            </div>
        </div>
